    ...
    <section class="py-16 bg-zinc-100 dark:bg-zinc-900 my-25">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-14">
                <h1
                    class="font-DanaDemiBold text-4xl text-zinc-800 dark:text-white mb-4"
                >
                    تماس با ما
                </h1>
                <p class="text-zinc-500 dark:text-zinc-300 max-w-2xl mx-auto">برای ثبت سفارش، دریافت مشاوره خرید، همکاری و یا هرگونه سوال با تیم گلدن کافی در ارتباط باشید.</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-5">
                    <div
                        class="bg-white dark:bg-zinc-800 rounded-2xl p-6 shadow-lg border border-orange-100"
                    >
                ...
                <div class="lg:col-span-2">
                    <div
                        class="bg-white dark:bg-zinc-800 rounded-2xl shadow-lg p-8 border border-orange-100"
                    >
                        <h3
                            class="font-DanaDemiBold text-2xl text-zinc-800 dark:text-white mb-8"
                        >
                            ارسال پیام
                        </h3>
                        ...
                        <form class="space-y-5">
                            ...
                            <textarea
                                ...
                                class="w-full rounded-xl border border-zinc-200 dark:border-zinc-600 bg-white dark:bg-zinc-700 p-4 focus:border-orange-400 outline-none"
                            ></textarea>
            ...
            <!-- نقشه -->
            <div
                class="mt-12 bg-white dark:bg-zinc-800 rounded-2xl overflow-hidden shadow-lg border border-orange-100"
            >
                <div
                    class="h-[350px] bg-zinc-200 dark:bg-zinc-700 flex items-center justify-center"
                >
                    <span class="text-zinc-500">
