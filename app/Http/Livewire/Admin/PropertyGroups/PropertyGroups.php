...
namespace App\Http\Livewire\Admin\PropertyGroups;
...
class PropertyGroups extends Component
{
    ...
    {
        $property_groups = PropertyGroup::query()->where('title','like','%'.$this->search.'%')->paginate(10);
        return view('livewire.admin.property-groups.property-groups' , compact('property_groups'));
    }
}
