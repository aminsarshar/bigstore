<div class="shadow-xl rounded-xl bg-white dark:bg-zinc-700">
    <div class="grid grid-cols-1 md:grid-cols-3 text-white">
        <div>
            ...
            >
                ...
                >
                    ...
                    <!-- Thumbs -->
                    <div
                        class="swiper mySwiper px-3 pb-3 mt-2"
                        wire:ignore
                        style="height: 93px; margin-top: -93px"
                    >
                        <div class="swiper-wrapper">
        ...
        <div class="p-7">
            <h2
                class="font-DanaDemiBold text-zinc-700 dark:text-white text-xl line-clamp-2 mb-2"
            >
                {{ $products->title }}
            </h2>
            <div
                class="flex items-center justify-start py-3 gap-x-3 border-t border-dashed border-zinc-200 dark:border-zinc-400"
            >
                <span>
                ...
                <span class="text-zinc-700 dark:text-white">1240 بازدید</span>
            </div>

            <div class="mt-4">
                <h3
                    class="font-DanaDemiBold text-xl text-zinc-700 dark:text-white"
                >
                    توضیحات :
                </h3>
                <ul
                            ...
                            <li class="ui-variant" wire:click="ChangeProduct({{$color->id}})">
                                <label class="ui-variant ui-variant--color">
                                    <span class="ui-variant-shape"
                                        style="background-color: {{ $color->code_color }}"></span>
                                    <input type="radio" value="1" name="color"
                                        class="variant-selector"
                                        @if ($products->productGuaranties()->where('price', $products->price)->first()->color_id == $color->id) checked @endif>
        ...
        <div class="p-7">
            <div
                class="border border-orange-200 dark:border-zinc-800 rounded-lg p-[10px] bg-gray-100 dark:bg-zinc-800/10 shadow-md md:w-[85%] md:m-auto"
            >
                <ul
                ...
                >
                    ...
                    <div class="flex text-sm mb-[10px]">
                        ...
                        <span class="mx-1">:</span>
                        <li>{{ $product_guaranty->guaranty->name }}</li>
                    </div>
                    <div class="flex text-sm mb-[10px]">
                        <li class="flex">
                            <svg
                ...
                <div>
                    <div
                        class="flex justify-between font-DanaDemiBold items-center text-orange-300 border-b border-gray-200 dark:border-white/10 py-5"
                    >
                        ...
                        <div class="flex gap-x-1.5">
                            <div>
                                <span
                                    class="text-2xl"
                                    >{{ number_format($product_guaranty->price) }}</span
                                >
                                <span>تومان</span>
                            </div>
                            @if ($products->discount != 0)
                                <div class="offer mt-1.5">
                                    <span
                                        class="text-sm text-gray-400 mr-1.5"
                                        >{{ number_format(($product_guaranty->price * 100) / (100 - $products->discount)) }}</span
                                    >
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div
                        class="flex items-center rounded-2xl border border-zinc-300 overflow-hidden"
                    >
                        <button
                            type="button"
                            wire:click="decrement"
                            class="w-8 h-8 flex items-center justify-center bg-white m-2 rounded-lg text-gray-300 transition"
                        >
                            -
                        </button>
                        ...
                        <button
                            ...
                            class="w-8 h-8 flex items-center justify-center m-2 rounded-lg bg-orange-500 hover:text-white transition"
                        >
                            +
                        </button>
                    </div>
    ...
    <div
        class="flex items-center justify-between flex-wrap gap-y-11 text-zinc-700 dark:text-white child:w-1/2 lg:child:w-auto p-10 border-t border-gray-200"
    >
        <div
            class="flex flex-col items-center sm:flex-row gap-x-4 gap-y-5 text-center lg:text-right"
        >
            <!-- Light Theme -->
            <svg
                class="dark:hidden"
            ...
            <div>
                <h5 class="font-DanaDemiBold text-sm md:text-lg mb-1 md:mb-3.5">
                    پشتیبانی شبانه روزی
                </h5>
        ...
        >
            ...
            <div>
                ...
                <span class="text-xs md:text-sm/6"
                    >تازه برشته شده و با کیفیت</span
                >
            </div>
        </div>
