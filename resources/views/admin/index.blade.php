                            ...
                            <ul class="list-unstyled base-timeline activity-timeline">
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="#" class="text-uppercase text-danger">وظیفه اضافه شده
                                            است</a>
                                    </div>
                                ...
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="#" class="text-uppercase text-primary">معامله اضافه
                                            شده</a>
                                    </div>
                                    <small class="text-muted">
                                        23 ساعت پیش
                                ...
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="#" class="text-uppercase text-dark">وظیفه به روز شده
                                            است</a>
                                    </div>
                                    <small class="text-muted">
                                        15 روز پیش
                                ...
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="#" class="text-uppercase text-warning">وظیفه شروع شده
                                            است</a>
                                    </div>
                                    <small class="text-muted">
                                        20 روز پیش
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-success round mb-0"
                                            type="button">تبلت</button>
                                    </td>
                                    <td>
                                        <div class="box-shadow-2 mt-1">
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar progress-bar-striped bg-success"
                                                    role="progressbar" aria-valuenow="75" aria-valuemin="20"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="box-shadow-2 mt-1">
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar progress-bar-striped bg-danger"
                                                    role="progressbar" aria-valuenow="70" aria-valuemin="20"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="box-shadow-2 mt-1">
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar progress-bar-striped bg-success"
                                                    role="progressbar" aria-valuenow="60" aria-valuemin="20"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="box-shadow-2 mt-1">
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar progress-bar-striped bg-danger"
                                                    role="progressbar" aria-valuenow="45" aria-valuemin="20"
