        ...
        (e.prototype.createElements = function () {
            ...
            i(this.settings.tpl.errorLine).appendTo(e),
                ...
                this.settings.showLoader === !0 &&
                    ((this.loader = i(this.settings.tpl.loader)),
                    this.loader.insertBefore(this.input)),
                (this.preview = i(this.settings.tpl.preview)),
                this.preview.insertAfter(this.input),
                this.isDisabled === !1 &&
                    this.settings.showRemove === !0 &&
                    ((this.clearButton = i(this.settings.tpl.clearButton)),
            ...
            "" != t.trim() &&
                ((this.file.name = this.cleanFilename(t)), this.setPreview(t));
        }),
        ...
        (e.prototype.setPreview = function (e) {
            ...
            if ((this.hideLoader(), this.isImage() === !0)) {
                ...
                this.settings.height &&
                    s.css("max-height", this.settings.height),
                    s.appendTo(t);
            } else
                i("<i />").attr("class", "dropify-font-file").appendTo(t),
                    i('<span class="dropify-extension" />')
            ...
            if (0 === this.errorsEvent.errors.length) {
                ...
                this.input.trigger(e, [this]),
                    e.result !== !1 &&
                        ...
                        this.input.val(""),
                        this.resetPreview(),
                        this.input.trigger(i.Event("dropify.afterClear"), [
                            this,
                        ]));
        ...
        (e.prototype.maxFileSizeToByte = function () {
            ...
            if (0 !== this.settings.maxFileSize) {
                var e = this.settings.maxFileSize.slice(-1).toUpperCase(),
                    ...
                    r = 1024 * s;
                "K" === e
                    ? (i = parseFloat(this.settings.maxFileSize) * t)
                    : "M" === e
                    ? (i = parseFloat(this.settings.maxFileSize) * s)
                    : "G" === e &&
                      (i = parseFloat(this.settings.maxFileSize) * r);
            }
            return i;
        }),
