        ...
        >
            <div>
                <div class="relative mb-2 md:mb-5">
                    <img
                        src="{{ asset('front/images/products/p1.png') }}"
                        alt="product-1"
                        loading="lazy"
                ...
                <div class="flex gap-x-2 md:gap-x-2.5 mt-1.5 md:mt-2.5">
                    <div class="text-teal-600 dark:text-emerald-500">
                        <span class="text-base md:text-xl font-DanaDemiBold"
                            >154,000</span
                        >
                        <span class="text-xs md:text-sm tracking-tightest"
                            >تومان</span
                        >
                    </div>
                    <div class="offer">
                        ...
                        <span
                            class="hidden lg:inline-block text-xs md:text-sm tracking-tightest"
                            >تومان</span
                        >
                    </div>
                </div>
