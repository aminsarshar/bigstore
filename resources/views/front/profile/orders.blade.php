...
@section ('profile-content')
    <div class="bg-white dark:bg-zinc-800 rounded-3xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="font-DanaDemiBold text-2xl">سفارش‌های من</h2>
        ...
        @forelse ($orders as $order)
            ...
            >
                ...
                >
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="font-DanaDemiBold text-lg text-orange-500"
                            >
                                #{{ $order->order_code }}
                            </span>
                        </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 mt-8">
                    <div>
                        <p class="text-gray-400 text-sm">مبلغ سفارش</p>

                        <h4
                            class="font-DanaDemiBold text-xl text-orange-500 mt-2"
                        >
                    ...
                    <div>
                        <p class="text-gray-400 text-sm">تعداد کالا</p>
                    ...
                    <div>
                        <p class="text-gray-400 text-sm">کد پیگیری</p>

                        <h4
                            class="font-DanaDemiBold text-lg mt-2 break-all text-left"
                        >
                ...
                <div class="mt-8 flex justify-end">
                    <a
                        href="{{ route('profile.order.show',$order) }}"
        ...
        @empty
            ...
            >
                ...
                <p class="text-gray-400 mt-3">اولین خرید خود را از فروشگاه انجام دهید.</p>
