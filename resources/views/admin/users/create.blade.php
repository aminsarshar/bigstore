        ...
        <div class="row match-height">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="px-3">
                            <form class="form" novalidate method="POST" action="{{ route('users.store') }}"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 mb-2">
                                            ...
                                            <input type="text" placeholder="شماره تماس" name="mobile" class="form-control" required data-validation-required-message="فیلد شماره تماس الزامی است">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-2">
                                            ...
                                            <input type="text" placeholder="لینک اینستاگرام" name="instagram" class="form-control" required data-validation-required-message="فیلد لینک اینستاگرام الزامی است">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 mb-2">
                                            ...
                                            <div class="controls">
                                                <input type="file" class="custom-file-input" id="inputGroupFile01" name="image" required data-validation-required-message="فیلد لینک فایل الزامی است">
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn btn-danger mr-1">
                                        <a class="text-white" href="{{route('users.index')}}"><i class="icon-trash"></i> لغو</a>
                                    </button>
