    ...
    <section class="py-16 bg-gray-50 dark:bg-zinc-800 my-25">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-14">
                <span class="inline-block px-4 py-2 rounded-full bg-orange-100 text-orange-500 font-DanaMedium mb-4">
                    درباره ما
                </span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <!-- تصویر -->
                <div class="relative">
                    <div class="absolute inset-0 bg-orange-300 rounded-3xl rotate-3">
                    </div>
                ...
                <div>
                    ...
                    <h3 class="font-DanaDemiBold text-2xl md:text-4xl text-zinc-700 dark:text-white mb-6">
                        عشق ما، قهوه با کیفیت است
                    </h3>

                    <p class="text-zinc-600 dark:text-zinc-300 leading-8 mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mt-20">
                ...
                <div class="bg-white dark:bg-zinc-700 rounded-2xl p-6 text-center shadow">
