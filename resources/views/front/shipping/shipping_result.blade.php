...
@section ('content')
    @if ($result === 'successful')
        <div class="container mx-auto px-4 py-16 my-28">
            <div class="mx-auto max-w-2xl">
                <div
                    class="rounded-[32px] border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm overflow-hidden"
                >
                    <div class="p-10 text-center">
                        <div
                            class="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-900/30"
                        >
                            <svg
                        ...
                        <h1
                            class="mt-8 text-3xl font-black text-zinc-900 dark:text-white"
                        >
                            پرداخت با موفقیت انجام شد
                        </h1>

                        <p class="mt-4 text-zinc-500 dark:text-zinc-400 leading-8">سفارش شما با موفقیت ثبت شد. کارشناسان ما در سریع‌ترین زمان ممکن سفارش را بررسی و ارسال خواهند کرد.</p>
                    </div>

                    <div class="border-t border-zinc-100 dark:border-zinc-800">
                        <div class="grid grid-cols-2 gap-6 p-8">
                            <div>
                                <p class="text-sm text-zinc-500">شماره سفارش</p>
                            ...
                            <div>
                                <p class="text-sm text-zinc-500">مبلغ پرداخت</p>
                            ...
                            <div>
                                ...
                                <span
                                    class="mt-2 inline-flex rounded-full bg-emerald-100 px-3 py-1 text-sm font-bold text-emerald-700"
                                >
                                    پرداخت شده
                                </span>
                            </div>
                            ...
                            <div>
                                <p class="text-sm text-zinc-500">تاریخ</p>
                    ...
                    <div
                        class="flex flex-wrap justify-center gap-4 p-8 border-t border-zinc-100 dark:border-zinc-800"
                    >
                        <a
    ...
    @else
        <div class="container mx-auto px-4 py-16 my-28">
            <div class="mx-auto max-w-2xl">
                <div
                    class="overflow-hidden rounded-[32px] border border-red-100 bg-white shadow-sm dark:border-red-900/30 dark:bg-zinc-900"
                >
                    <div class="p-10 text-center">
                        <div
                        ...
                        <p class="mt-4 leading-8 text-zinc-500 dark:text-zinc-400">متأسفانه پرداخت شما تکمیل نشد و مبلغی از حساب شما کسر نگردید. در صورت کسر وجه، مبلغ طی ۲۴ تا ۷۲ ساعت کاری توسط بانک به حساب شما باز خواهد گشت.</p>
                    </div>

                    <div class="border-y border-zinc-100 dark:border-zinc-800">
                        <div class="grid grid-cols-2 gap-6 p-8">
                            <div>
                                <p class="text-sm text-zinc-500">کد پیگیری</p>
                            ...
                            <div class="col-span-2">
                                <p class="text-sm text-zinc-500">علت خطا</p>
