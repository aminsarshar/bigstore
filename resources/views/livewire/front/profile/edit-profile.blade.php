<div>
    ...
    <div class="bg-white rounded-3xl shadow-sm overflow-hidden">
        ...
        <div class="p-8 border-b">
            ...
            <h2 class="text-2xl font-DanaDemiBold">
                اطلاعات حساب
            </h2>
...
@enderror
        ...
        <div class="col-span-12">
            ...
            {{-- اطلاعات شخصی --}}
            <div class="bg-white rounded-3xl shadow-sm border border-zinc-200 p-8 mb-8">
                ...
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm mt-1">
                            اطلاعات اصلی حساب کاربری خود را تکمیل کنید.
                        </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <label class="block mb-2 text-sm font-DanaMedium">
                            نام و نام خانوادگی
                        </label>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-zinc-200 p-8 mb-8">
                ...
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm mt-1">
                            شبکه‌های ارتباطی خود را ثبت کنید.
                        </p>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-zinc-200 p-8 mb-8">
                ...
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm mt-1">
                            در صورت تمایل اطلاعات شبکه‌های اجتماعی خود را وارد کنید.
                        </p>
