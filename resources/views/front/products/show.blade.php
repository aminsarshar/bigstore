    ...
    <main>
        <section class="category-banner mt-10 md:mt-[210px] mb-10">
            <div class="container">
                ...
                <div
                    class="shadow-xl rounded-xl bg-white dark:bg-zinc-700 mt-10"
                >
                    <div class="w-full">
                        <div class="relative left-0">
                            ...
                            >
                                <li class="z-30 flex-auto text-center">
                                    <a
                                        class="z-30 flex items-center justify-center w-full px-0 py-1 mb-0 transition-all ease-in-out border-0 rounded-lg cursor-pointer text-slate-700 dark:text-gray-500 bg-inherit"
                                        data-tab-target=""
                                        active=""
                                        role="tab"
                                        aria-selected="true"
                            ...
                            <div
                                data-tab-content=""
                                class="p-5 mt-10 border-t border-gray-300"
                            >
                                <div
                                    ...
                                    <div class="container">
                                        ...
                                        >
                                            <div>
                                                <div class="">
                                                    <h2
                                                        class="flex items-center gap-x-2 text-gray-700 dark:text-white"
                                                    >
                                                        <svg
                                                ...
                                                <ul
                                                    class="mt-9 child:text-black child:dark:text-white"
                                                >
                                                    <div
                                ...
                                >
                                    <h2 class="text-2xl">
                                        توضیحات محصول : قهوه بن مانو
                                    </h2>
                                    <p
                                        class="block text-base antialiased font-light leading-relaxed text-inherit text-blue-gray-500 mt-6"
                                    >معرفی محصول دانه قهوه ویتالی از ترکیب 30% قهوه عربیکا و 70% ربوستا با درجه برشته‌کاری مدیوم دارک تهیه شده است. میزان کافئین ویتالی بالا و طعم‌یاد شکلاتی دارد. به‌طور معمول، افراد به قصد خرید قهوه اسپرسو، دانه قهوه ویتالی را تهیه می‌کنند. اما دانه قهوه ویتالی را می‌توان به سایز پودر قهوه ترک و فرانسه آسیاب کرد و با دم‌افزارهایی مانند جذوه، فرنچ پرس و موکاپات قهوه تهیه کرد.</p>
                                </div>
                                <div
                                    class="hidden opacity-0"
                                    id="settings"
                                ...
                                >
                                    ...
                                    >Comparing yourself to others is the thief of joy.</p>
                                </div>
                                <div
                                    class="hidden opacity-0"
                                    id="desc"
                                ...
                                >
                                    <div>
                                        ...
                                        <p class="text-gray-600 dark:text-gray-200 mt-3">برای ثبت نظر، از طریق دکمه افزودن دیدگاه جدید نمایید. اگر این محصول را قبلا خریده باشید، نظر شما به عنوان خریدار ثبت خواهد شد.</p>
                                    </div>

                                    <div class="container">
                                        <div class="lg:pr-[20%] mt-10">
                                            <h5
                                                class="my-4 text-gray-600 dark:text-gray-200"
                                            >
                                                امتیاز شما
                                            </h5>
                                            <div
                                                class="flex text-yellow-400 mb-4"
                                            >
                                            ...
                                            ></textarea>
                                            <div
                                                class="grid grid-cols-1 lg:grid-cols-2 lg:w-[75%]"
                                            >
                                                <div class="block">
                                                    <label
                                                        for=""
                                                        class="block my-2.5 text-teal-800 dark:text-teal-400"
                                                        >نقاط قوت</label
                                                    >
                                                    <input
                                                        type="text"
                                                ...
                                                <div>
                                                    <label
                                                        for=""
                                                        class="block my-2.5 text-red-600 lg:mr-[10px]"
                                                        >نقاط ضعف</label
                                                    >
                                                    <input
                                                        type="text"
                                    ...
                                    @foreach ($products->Subcomments as $comment)
                                        ...
                                        >
                                            <div
                                                class="block md:flex items-center justify-between p-5"
                                            >
                                                <div
                                                    class="flex items-center gap-x-2.5"
                                                >
                                                    <div
                                                        class="bg-white flex items-center p-2 rounded-full"
                                                    >
                                                        <img
                                                            src="./images/user.png"
                                                            alt=""
                                                    ...
                                                    <span
                                                        class="text-black dark:text-white"
                                                        >{{ verta($comment->created_at)->format('%d  %B   %Y') }}</span
                                                    >
                                                </div>
                                                <div>
                                                    <div
                                                        class="flex justify-end text-yellow-400"
                                                    >
                                                        <svg
