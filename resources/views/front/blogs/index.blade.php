    ...
    <div class="container mx-auto px-5 relative z-10 mt-16">
        ...
        <div
            ...
            <div class="lg:w-1/2 text-center lg:text-right">
                ...
                <p
                    class="mt-8 text-gray-300 leading-9 max-w-xl">
...
<section class="bg-white dark:bg-zinc-800 py-10">
    ...
    <div class="container mx-auto px-4">
        ...
        <div
            class="bg-white dark:bg-zinc-700 rounded-3xl shadow-lg p-5">
    ...
    <div class="container mx-auto px-4">
        ...
        <div
            ...
            <div class="p-10">
                ...
                <p
                    class="mt-5 leading-8 text-gray-500">
                ...
                <a
                    href="#"
                    class="inline-flex mt-8 text-orange-500">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 m-14">
    ...
    <div
        ...
        <div class="p-5">
            ...
            <p
                class="mt-3 text-sm text-gray-500 dark:text-gray-300 line-clamp-3 leading-7">
                توضیحات کوتاه مقاله...
            </p>
