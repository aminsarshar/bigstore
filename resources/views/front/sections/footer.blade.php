...
<footer class="relative bg-zinc-700 py-8 md:py-11">
    ...
    <a href="#">
        <div
            class="w-[30px] h-[30px] rounded-full border-2 -translate-y-2/4 border-orange-300 hidden md:flex justify-center items-center absolute top-0 right-0 left-0 mx-auto"
        >
    ...
    <div
        class="flex flex-wrap justify-between sm:w-[94%] lg:w-[90%] mx-auto text-gray-300 px-4 md:px-0"
    >
        <div>
            ...
            <p class="text-lg md:text-xl/[48px] max-w-[606px] xl:max-w-[606px] lg:max-w-full">ما برآنیم تا با پیشرو بودن در فرآیند تولید، نوع و کیفیت محصول، خدمات و توزیع، الگویی برای تولیدکنندگان ایرانی باشیم و به مرجع فرهنگ قهوه در ایران تبدیل شویم. می‌پنداریم که نظر مردم ایران و منطقه باید نسبت به کالای ایرانی بهبود یابد و در این راستا با اشتیاق می‌کوشیم.</p>
        </div>
        ...
        <div class="mt-10 md:mt-[26px]">
            ...
            <div
                class="grid grid-cols-2 gap-y-2.5 md:gap-y-5 gap-x-10 md:gap-x-16"
            >
                <a
                    href="#"
                    class="flex items-center md:text-xl gap-x-2 md:gap-x-3"
                >
                    <span
                        class="inline-block w-2 md:w-2.5 h-1 bg-current rounded-full"
                    ></span>
                    حریم خصوصی
                </a>
                <a
                ...
                <a
                    href="#"
                    class="flex items-center md:text-xl gap-x-2 md:gap-x-3 hover:text-orange-300 transition-colors"
                >
                    <span
                        class="inline-block w-2 md:w-2.5 h-1 bg-current rounded-full"
                    ></span>
        ...
        <div class="mt-10 md:mt-[26px]">
            ...
            <div>
                <div class="md:text-xl mb-6 md:mb-10">
                    <span
                        class="flex items-center gap-x-2 md:gap-x-3 mb-4 md:mb-5"
                    >
                ...
                <div
                    class="flex gap-x-1.5 md:gap-x-6 ltr-text font-DanaMedium md:text-xl"
                >
                    <a
                        href=""
        ...
        <div
            class="flex flex-wrap justify-between items-center gap-4 font-DanaMedium pt-10 md:pt-11 mt-10 md:mt-11 border-t border-white/10 w-full"
        >
            <div>
                <div></div>
...
<div
    class="overly md:hidden bg-black/40 fixed inset-0 w-full h-full z-10 transition-all"
></div>
...
<script>
    ...
    !(function (a) {
        ...
        ((b.prototype = {
            ...
            stop: function () {
                this.active &&
                    ((this.active = !1), clearInterval(this.autoUpdate));
            },
            end: function () {
                this.date &&
                    (this.stop(),
