...
@section('content')
    <main id="products-section2">
        ...
        <section
            class="home relative h-[200px] xs:h-auto xs:aspect-[2/1] bg-home-mobile md:bg-home-desktop bg-no-repeat bg-cover bg-[center_top]">
            <div class="container overflow-y-hidden relative md:min-h-screen flex items-center justify-end h-full">
                <div class="text-white">
                    <h2 class="font-MorabbaBold text-2xl md:text-6xl/[62px] mb-0.5 md:mb-2">
                        قهوه عربیکا تانزانیا
                    </h2>
                    <span class="font-MorabbaLight text-xl md:text-5xl/[64px]">
                        یک فنجان بالانس !
                    </span>
                    <span class="block w-[100px] h-px md:h-0.5 bg-orange-300 my-3 md:my-8"></span>
                    <p class="max-w-[201px] md:max-w-[460px] text-xs md:text-2xl">قطعا نام عربیکا را شنیده اید. عربیکا یکی از
                        گونه های قهوه است که در نواحی مختلف کمربند قهوه کشت میشود.</p>
                </div>
            ...
            <!-- Curve -->
            <svg
                class="absolute hidden md:inline-block bottom-0 right-0 left-0 mx-auto text-gray-100 dark:text-zinc-800 w-[100px] h-[22px]">
                <use href="#home-curve"></use>
            </svg>
            ...
            <a href="#products-section">
                <div
                    class="w-[30px] h-[30px] rounded-full border-2 translate-y-2/4 border-orange-300 hidden md:flex justify-center items-center absolute bottom-0 right-0 left-0 mx-auto">
                    <svg class="w-[18px] h-[18px] text-zinc-700 dark:text-white">
        ...
        {{--
    <section class="sliderr pt-8 md:pt-24 lg:pt-48">
      <div class="container">
  <!-- Swiper -->
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <img src="{{asset('front/images/slide1.webp')}}" alt="" style="padding: 0px !important;">
      </div>
      <div class="swiper-slide">
        <img src="{{asset('front/images/slide2.webp')}}" alt="" style="padding: 0px !important;">
      </div>
      <div class="swiper-slide">
        <img src="{{asset('front/images/slide1.webp')}}" alt="" style="padding: 0px !important;">
      </div>
    ...
    <div class="swiper-pagination"></div>
        ...
        <section class="products pt-8 md:pt-24 lg:pt-48" id="products-section">
            ...
            <div class="container">
                ...
                <div class="flex justify-between items-end mb-5 md:mb-12">
                    <div>
                        <h3 class="section-title">جدیدترین محصولات</h3>
                        <span class="section-subtitle">فرآوری شده از دانه قهوه</span>
                    </div>
                ...
                <!-- Section Body -->
                <div
                    class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3.5 md:gap-5 child:md:p-5 child:p-2  child:bg-white child:dark:bg-zinc-700 child:rounded-2xl child:shadow-normal child:dark:shadow-normal">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-x-2 md:gap-x-2.5 mt-1.5 md:mt-2.5">
                            <div class="text-teal-600 dark:text-emerald-500">
                                <span class="text-base md:text-xl font-DanaDemiBold">184,000</span>
                                <span class="text-xs md:text-sm tracking-tightest">تومان</span>
                            </div>
                            <!-- <div class="offer">
                                <span class="text-xs md:text-xl">175,000</span>
                    ...
                    <div>
                        ...
                        <div class="flex gap-x-2 md:gap-x-2.5 mt-1.5 md:mt-2.5">
                            <div class="text-teal-600 dark:text-emerald-500">
                                <span class="text-base md:text-xl font-DanaDemiBold">165,000</span>
                                <span class="text-xs md:text-sm tracking-tightest">تومان</span>
                            </div>
                            <div class="offer">
                                <span class="text-xs md:text-xl">194,000</span>
                                <span class="hidden lg:inline-block text-xs md:text-sm tracking-tightest">تومان</span>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-x-2 md:gap-x-2.5 mt-1.5 md:mt-2.5">
                            <div class="text-teal-600 dark:text-emerald-500">
                                <span class="text-base md:text-xl font-DanaDemiBold">204,000</span>
                                <span class="text-xs md:text-sm tracking-tightest">تومان</span>
                            </div>
                            <!-- <div class="offer">
                                <span class="text-xs md:text-xl">175,000</span>
                    ...
                    <div>
                        ...
                        <div class="flex gap-x-2 md:gap-x-2.5 mt-1.5 md:mt-2.5">
                            <div class="text-teal-600 dark:text-emerald-500">
                                <span class="text-base md:text-xl font-DanaDemiBold">134,000</span>
                                <span class="text-xs md:text-sm tracking-tightest">تومان</span>
                            </div>
                            <!-- <div class="offer">
                                <span class="text-xs md:text-xl">175,000</span>
                    ...
                    <div>
                        <div class="relative mb-2 md:mb-5">
                            <img src="./images/products/p8.png" alt="product-1" class="w-32 md:w-auto mx-auto">
                            <!-- <span class="absolute top-1.5 right-1.5 font-DanaDemiBold text-xs md:text-base text-white dark:text-zinc-700 px-2.5 md:px-3.5 rounded-full h-5 md:h-[30px] block bg-orange-300 leading-[25px] md:leading-[34px]">12%</span> -->
                        </div>
                        <h5
                            class="font-DanaMedium text-sm md:text-xl text-zinc-700 dark:text-white line-clamp-2 md:min-h-[56px] min-h-[40px]">
        ...
        <section class="category-banner mt-8 mb-10 md:my-20">
            <div class="container">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 text-white">
                    <a href="#">
                        <div
                            class="category-banner__item1 flex flex-col justify-center pr-7 md:pr-12 rounded-2xl h-[142px] md:h-[248px]">
                            <h5 class="font-DanaDemiBold text-2xl/6 md:text-4xl/6 mb-4 md:mb-7 ">انواع قهوه</h5>
                            <span class="md:font-DanaMedium md:text-xl/6">ترکیبی و تگ خاستگاه</span>
                        </div>
                    </a>
                    <a href="#">
                        <div
                            class="category-banner__item2 flex flex-col justify-center pr-7 md:pr-12 rounded-2xl h-[142px] md:h-[248px]">
                            <h5 class="font-DanaDemiBold text-2xl/6 md:text-4xl/6 mb-4 md:mb-7">پودر های فوری</h5>
                            <span class="md:font-DanaMedium md:text-xl/6">نسکافه , هات چاکلت , ماسالا</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <section class="coffee-club mb-8 md:mb-20">
            <div class="container">
                <div
                    class="coffee__club lg:h-36 rounded-2xl px-3 py-8 lg:py-0 xl:px-11 lg:px-5 text-white flex items-center flex-wrap xl:gap-x-24 lg:gap-x-4 gap-y-9 lg:flex-nowrap">
                    <!-- Right Items -->
                    <div class="flex items-center gap-x-3 lg:gap-x-4 xl:gap-x-6 md:shrink-0">
                        ...
                        <div>
                            ...
                            <p class="font-MorabbaLight text-lg md:text-2xl">میدونستی میتونی با امتیاز هات قهوه بگیری ؟</p>
                        </div>
                    </div>
                    <!-- Left Items -->
                    <div class="flex justify-between w-full">
                        <!-- Box Items -->
                        <div class="flex gap-x-2 lg:gap-x-3 xl:gap-x-5">
                            <div
                                class="w-[72px] h-[72px] md:w-[98px] md:h-[98px] text-center bg-white text-emerald-600 rounded-2xl py-1.5 md:pt-5 md:pb-1">
                        ...
                        <div class="flex flex-col">
                            <span class="md:mb-1 font-DanaDemiBold text-2xl md:text-3xl">542</span>
                            <span class="text-xs md:text-sm">امتیـــــــاز شما</span>
                            <a href="#"
                                class="coffee-club-link flex items-center justify-center mt-1 md:mt-2 w-[90px] h-[26px] md:w-[110px] md:h-8 rounded-full font-DanaMedium text-xs md:text-sm">
                                دریافت جایزه
        ...
        <section class="blogs mb-8 md:mb-28">
            <div class="container">
                ...
                <div class="flex justify-between items-end mb-5 md:mb-12">
                    <div>
                        <h3 class="section-title">مطالب خواندنی</h3>
                    </div>
                    <a href="#" class="section-link">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-3.5 md:gap-5">
                    <a href="#">
                        <div class="flex sm:block bg-white dark:bg-zinc-700 shadow-normal rounded-2xl p-2.5 md:pb-2 group">
                            <div
                            ...
                            <div>
                                <div class="block sm:flex justify-between mr-[10px] w-full">
                                    <h2
                                        class="text-sm/7 md:text-lg font-DanaMedium md:font-Dana mt-2.5 sm:mt-0 text-zinc-700 dark:text-white line-clamp-2 max-w-[193px] ml-1.5 sm:ml-0">
                                        طرز تهیه قهوه دمی با دستگاه اروپرس</h2>
                                    <div
                                        class="hidden sm:flex flex-col text-teal-600 dark:text-emerald-500 text-sm text-left ml-[12px] lg:ml-[18px] pr-5 mr-5 lg:border-r lg:border-gray-200 lg:dark:border-white/10">
                                        <span class="font-DanaDemiBold md:text-xl lg:text-2xl">21</span>
                                        <span>مرداد</span>
                                        <span>1402</span>
                                    </div>
                                </div>
                                <div
                                    class="flex items-end justify-between sm:hidden border-t border-t-gray-100 dark:border-t-white/10 pt-[18px] w-full pb-1.5">
                                    <span class="text-teal-600 dark:text-emerald-500 text-xs">21 مرداد 1402</span>
                                    <div
                                        class="flex items-center sm:hidden gap-x-1 font-DanaMedium text-xs h-5 rounded-md pr-2.5 pl-2 bg-orange-200/20 text-orange-300 ml-1.5">
                                        مطالعه
                ...
                <div class="flex flex-col lg:flex-row items-center lg:items-start gap-y-8 lg:gap-x-5">
                    ...
                    <div class="text-zinc-700 dark:text-white">
                        ...
                        <p class="text-lg md:text-2xl">
                            فضای گرم و دنج ما را احساس کنید، جایی که همه می توانند قهوه معطری پیدا کنند و دسرهای خوشمزه ما
                            را که کاملاً با قهوه داغ همراه شده است، امتحان کنند. فضای داخلی شیک و کارکنان خوش برخورد ما روز
                            شما را می سازد!
                        </p>
                        <a href="#"
                            class="inline-flex items-center justify-center h-[50px] md:h-[60px] px-6 mt-5 md:mt-6 border md:border-2 border-orange-300 rounded-full text-orange-300 gap-x-2 md:text-xl tracking-tightest">
                            <svg class="w-5 h-5 md:w-8 md:h-8">
                                <use href="#contactus-phone"></use>
                            </svg>
                            ثبت سفارش تلفنی
                        </a>
                    </div>
        ...
        <section class="services mb-12 md:mb-36">
            <div class="container">
                <div
                    class="flex items-center justify-between flex-wrap gap-y-11 text-zinc-700 dark:text-white child:w-1/2 lg:child:w-auto">

                    <div class="flex flex-col items-center sm:flex-row gap-x-4 gap-y-5 text-center lg:text-right">
                        <!-- Light Theme -->
                        <svg class="dark:hidden" width="66" height="73" viewBox="0 0 66 73" fill="none"
                        ...
                        <div>
                            <h5 class="font-DanaDemiBold text-sm md:text-lg mb-1 md:mb-3.5">پشتیبانی شبانه روزی</h5>
                            <span class="text-xs md:text-sm/6">7 روز هفته ، 24 ساعته</span>
                        </div>
                    ...
                    <div class="flex flex-col items-center sm:flex-row gap-x-4 gap-y-5 text-center lg:text-right">
                        <!-- Light Theme -->
                        <svg class="dark:hidden" width="109" height="73" viewBox="0 0 109 73" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <h5 class="font-DanaDemiBold text-sm md:text-lg mb-1 md:mb-3.5">امکان تحویل اکسپرس</h5>
                            <span class="text-xs md:text-sm/6">ارسال بسته با سرعت باد</span>
                        </div>
                    ...
                    <div class="flex flex-col items-center sm:flex-row gap-x-4 gap-y-5 text-center lg:text-right">
                        <!-- Light Theme -->
                        <svg class="dark:hidden" width="52" height="73" viewBox="0 0 52 73" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <h5 class="font-DanaDemiBold text-sm md:text-lg mb-1 md:mb-3.5">رست تخصصی</h5>
                            <span class="text-xs md:text-sm/6">تازه برشته شده و با کیفیت</span>
                        </div>
                    ...
                    <div class="flex flex-col items-center sm:flex-row gap-x-4 gap-y-5 text-center lg:text-right">
                        <!-- Light Theme -->
                        <svg class="dark:hidden" width="76" height="73" viewBox="0 0 76 73" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <svg class="hidden dark:inline-block" width="76" height="73" viewBox="0 0 76 73"
                            ...
                            <path
                                ...
                                fill="white" />
                            <path
                                d="M52.2 56.1748C51.4268 56.1748 50.8 56.8017 50.8 57.5748V63.1748C50.8 63.948 50.1731 64.5749 49.3999 64.5749H43.7999C43.0268 64.5749 42.3999 65.2017 42.3999 65.9749C42.3999 66.748 43.0268 67.3749 43.7999 67.3749H49.3999C51.7201 67.3749 53.6 65.4943 53.6 63.1748V57.5748C53.6 56.8017 52.9731 56.1748 52.2 56.1748Z"
                                fill="white" />
                        </svg>

                        <div>
                            <h5 class="font-DanaDemiBold text-sm md:text-lg mb-1 md:mb-3.5">اکسسوری قهوه</h5>
                            <span class="text-xs md:text-sm/6">وسایل و ادوات دم آوری</span>
                        </div>
