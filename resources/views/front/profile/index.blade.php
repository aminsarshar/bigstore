    ...
    <div class="col-span-12 lg:col-span-9">
        <div class="grid md:grid-cols-4 gap-5">
            <div class="rounded-[28px] bg-white p-6 shadow-sm border">
                <p class="text-gray-400">سفارش ها</p>
            ...
            <div class="rounded-[28px] bg-white p-6 shadow-sm border">
                <p class="text-gray-400">آدرس ها</p>
            ...
            <div class="rounded-[28px] bg-white p-6 shadow-sm border">
                <p class="text-gray-400">مبلغ خرید</p>
        ...
        <div class="bg-white rounded-[30px] shadow-sm border mt-8">
            <div class="p-6 border-b">
                <h3 class="font-DanaDemiBold text-xl">آخرین سفارش ها</h3>
            </div>
                ...
                <tbody>
                    @forelse (auth()->user()->orders()->latest()->take(5)->get() as $order)
                        <tr class="border-b last:border-b-0">
                            <td class="p-4">#{{ $order->order_code }}</td>
                            ...
                            <td class="p-4">
                                @if ($order->status)
                                    <span
                                        class="bg-green-100 text-green-600 rounded-full px-3 py-1 text-sm"
                                    >
                                        پرداخت شده
                                    </span>
                                ...
                                @else
                                    <span
                                        class="bg-red-100 text-red-600 rounded-full px-3 py-1 text-sm"
                                    >
                                        ناموفق
                                    </span>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="py-16">
                                ...
                                >
                                    <div
                                        class="w-20 h-20 rounded-full bg-orange-100 flex items-center justify-center mb-5"
                                    >
                                        <svg
                                    ...
                                    <h4
                                        class="font-DanaDemiBold text-xl text-zinc-700"
                                    >
                                        هنوز سفارشی ثبت نکرده‌اید
                                    </h4>

                                    <p class="text-gray-400 mt-2">پس از ثبت اولین سفارش، اطلاعات آن در این قسمت نمایش داده می‌شود.</p>
