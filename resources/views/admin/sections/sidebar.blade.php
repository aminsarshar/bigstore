<div data-active-color="black" data-background-color="white" data-image="" class="app-sidebar">
    ...
    <div class="sidebar-content">
      <div class="nav-container">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class="nav-item {{ request()->is('dashboard') ? 'active' : '' }}"><a href="{{route('dashboard')}}"><i class="icon-home"></i><span data-i18n="" class="menu-title">داشبورد</span></a>
          ...
          <li class="has-sub nav-item"><a href="#"><i class="icon-users"></i><span data-i18n="" class="menu-title">کاربران</span></a>
            <ul class="menu-content">
              <li class="{{ request()->is('dashboard/users') ? 'active' : '' }}" ><a href="{{route('users.index')}}" class="menu-item">لیست کاربران</a>
              </li>
              <li class="{{ request()->is('dashboard/users/create') ? 'active' : '' }}" ><a href="{{route('users.create')}}" class="menu-item">ایجاد کاربر</a>
              </li>
            </ul>
              </li>
          @endhasanyrole
          ...
          <li class="has-sub nav-item"><a href="#"><i class="icon-magnet"></i><span data-i18n="" class="menu-title">اسلایدر ها</span></a>
            <ul class="menu-content">
              <li class="{{ request()->is('dashboard/sliders' , 'dashboard/sliders/edit') ? 'active' : '' }}"><a href="{{route('sliders.index')}}" class="menu-item">لیست اسلایدر ها</a>
              </li>
              <li class="{{ request()->is('dashboard/sliders/create') ? 'active' : '' }}"><a href="{{route('sliders.create')}}" class="menu-item">ایجاد اسلایدر</a>
              </li>
                </ul>
              </li>
              ...
              <li class="has-sub nav-item"><a href="#"><i class="icon-grid"></i><span data-i18n="" class="menu-title">دسته بندی ها</span></a>
                <ul class="menu-content">
                  ...
                  <li class="{{ request()->is('dashboard/trashed_category') ? 'active' : '' }}"><a href="{{route('categories.trashed')}}" class="menu-item"> دسته بندی های حذف شده</a>
                  </li>
                    </ul>
                  </li>

                  <li class="has-sub nav-item"><a href="#"><i class="icon-badge"></i><span data-i18n="" class="menu-title">برند ها</span></a>
                    <ul class="menu-content">
                      <li class="{{ request()->is('dashboard/brands' , 'dashboard/brands/edit') ? 'active' : '' }}"><a href="{{route('brands.index')}}" class="menu-item">لیست برند ها</a>
                      </li>
                      <li class="{{ request()->is('dashboard/brands/create') ? 'active' : '' }}"><a href="{{route('brands.create')}}" class="menu-item">ایجاد برند</a>
                      </li>
                        </ul>
                      </li>

                      <li class="has-sub nav-item"><a href="#"><i class="icon-badge"></i><span data-i18n="" class="menu-title">گارانتی ها</span></a>
                        <ul class="menu-content">
                          <li class="{{ request()->is('dashboard/guaranties' , 'dashboard/guaranties/edit') ? 'active' : '' }}"><a href="{{route('guaranties.index')}}" class="menu-item">لیست گارانتی ها</a>
                          </li>
                          <li class="{{ request()->is('dashboard/guaranties/create') ? 'active' : '' }}"><a href="{{route('guaranties.create')}}" class="menu-item">ایجاد گارانتی</a>
                          </li>
                            </ul>
                          </li>
                      ...
                      <li class="has-sub nav-item"><a href="#"><i class="ft-codepen"></i><span data-i18n="" class="menu-title">رنگ ها</span></a>
                        <ul class="menu-content">
                          <li class="{{ request()->is('dashboard/colors' , 'dashboard/colors/edit') ? 'active' : '' }}"><a href="{{route('colors.index')}}" class="menu-item">لیست رنگ ها</a>
                          </li>
                          <li class="{{ request()->is('dashboard/colors/create') ? 'active' : '' }}"><a href="{{route('colors.create')}}" class="menu-item">ایجاد رنگ</a>
                          </li>
                            </ul>
                          </li>

                          <li class="has-sub nav-item"><a href="#"><i class="icon-tag"></i><span data-i18n="" class="menu-title">برچسب ها</span></a>
                            <ul class="menu-content">
                              <li class="{{ request()->is('dashboard/tags' , 'dashboard/tags/edit') ? 'active' : '' }}"><a href="{{route('tags.index')}}" class="menu-item">لیست برچسب ها</a>
                              </li>
                              <li class="{{ request()->is('dashboard/tags/create') ? 'active' : '' }}"><a href="{{route('tags.create')}}" class="menu-item">ایجاد برچسب</a>
                              </li>
                                </ul>
                              </li>


                              <li class="has-sub nav-item"><a href="#"><i class="ft-shopping-cart"></i><span data-i18n="" class="menu-title">محصولات</span></a>
                                <ul class="menu-content">
                                  <li class="{{ request()->is('dashboard/products' , 'dashboard/products/edit') ? 'active' : '' }}"><a href="{{route('products.index')}}" class="menu-item">لیست محصولات</a>
                                  </li>
                                  <li class="{{ request()->is('dashboard/products/create') ? 'active' : '' }}"><a href="{{route('products.create')}}" class="menu-item">ایجاد محصول</a>
                                  </li>
                                    </ul>
                                  </li>

                                  <li class="has-sub nav-item"><a href="#"><i class="icon-doc"></i><span data-i18n="" class="menu-title">ویژگی محصولات</span></a>
                                    <ul class="menu-content">
                                      <li class="{{ request()->is('dashboard/property_groups' , 'dashboard/property_groups/edit') ? 'active' : '' }}"><a href="{{route('property_groups.index')}}" class="menu-item">لیست ویژگی محصولات</a>
                                      </li>
                                      <li class="{{ request()->is('dashboard/property_groups/create') ? 'active' : '' }}"><a href="{{route('property_groups.create')}}" class="menu-item">ایجاد گروه ویژگی</a>
                                      </li>
                                        </ul>
                                      </li>

                                  <li class="has-sub nav-item"><a href="#"><i class="icon-doc"></i><span data-i18n="" class="menu-title">بنر ها</span></a>
                                    <ul class="menu-content">
                                      <li class="{{ request()->is('dashboard/banners' , 'dashboard/banners/edit') ? 'active' : '' }}"><a href="{{route('banners.index')}}" class="menu-item">لیست ویژگی محصولات</a>
                                      </li>
                                      <li class="{{ request()->is('dashboard/banners/create') ? 'active' : '' }}"><a href="{{route('banners.create')}}" class="menu-item">ایجاد بنر</a>
                                      </li>
                                        </ul>
                                      </li>

                                      <li class="has-sub nav-item"><a href="#"><i class="icon-doc"></i><span data-i18n="" class="menu-title">کامنت ها</span></a>
                                        <ul class="menu-content">
                                          <li class="{{ request()->is('dashboard/comments' , 'dashboard/comments/edit') ? 'active' : '' }}"><a href="{{route('user.comments')}}" class="menu-item">کامنت محصولات</a>
                                          </li>
                                          {{-- <li class="{{ request()->is('dashboard/comments/create') ? 'active' : '' }}"><a href="{{route('comments.create')}}" class="menu-item">ایجاد بنر</a>
                                          </li> --}}
                                            </ul>
                                          </li>
    ...
    <ul class="menu-content">
        ...
        <li class="{{ request()->is('dashboard/orders' , 'dashboard/orders/index') ? 'active' : '' }}">
    ...
    <a href="#">
        <i class="icon-cup"></i>
        <span class="menu-title">گزارش مالی</span>
    </a>

    <ul class="menu-content">
        <li class="{{ request()->is('dashboard/reports/daily') ? 'active' : '' }}">
            <a href="{{ route('reports.daily') }}" class="menu-item">
                مشاهده گزارشات
            </a>
        </li>
